    ...
    if (reset) begin
      ...
      if (|state) begin
        if (_GEN) begin
          ...
          if (_GEN_0) begin
            if (tick & (&bitCounter)) state <= 2'h3;
          end else if ((&state) & tick) state <= 2'h0;
          if (~_GEN_1 | (&bitCounter)) begin
          end else bitCounter <= bitCounter + 3'h1;
        end
      end else if (io_channel_valid) state <= 2'h1;
      tick <= _tick_T_1;
      if (_tick_T_1) tickCounter <= 10'h0;
      else tickCounter <= tickCounter + 10'h1;
    end
    if (|state) begin
      if (_GEN | ~_GEN_1 | (&bitCounter)) begin
      end else data <= {1'h0, data[7:1]};
    end else if (io_channel_valid) data <= io_channel_bits;
  end  // always @(posedge)
...
module AsyncFIFOCtrlCore (
  ...
  always @(posedge io_wclk) begin
    if (reset) begin
      ...
      if (_wPtrNext_T_1) wPtr <= _wPtrPlus1_T_5;
  ...
  always @(posedge io_rclk) begin
    if (reset) begin
      ...
      if (_rPtrNext_T_1) rPtr <= _rPtrBinIncr_T;
...
module RegisterFileCore (
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (io_we & io_waddr == 6'h0) regFile_0_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h1) regFile_1_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h2) regFile_2_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h3) regFile_3_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h4) regFile_4_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h5) regFile_5_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h6) regFile_6_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h7) regFile_7_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h8) regFile_8_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h9) regFile_9_value <= io_wdata_value;
      if (io_we & io_waddr == 6'hA) regFile_10_value <= io_wdata_value;
      if (io_we & io_waddr == 6'hB) regFile_11_value <= io_wdata_value;
      if (io_we & io_waddr == 6'hC) regFile_12_value <= io_wdata_value;
      if (io_we & io_waddr == 6'hD) regFile_13_value <= io_wdata_value;
      if (io_we & io_waddr == 6'hE) regFile_14_value <= io_wdata_value;
      if (io_we & io_waddr == 6'hF) regFile_15_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h10) regFile_16_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h11) regFile_17_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h12) regFile_18_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h13) regFile_19_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h14) regFile_20_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h15) regFile_21_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h16) regFile_22_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h17) regFile_23_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h18) regFile_24_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h19) regFile_25_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h1A) regFile_26_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h1B) regFile_27_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h1C) regFile_28_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h1D) regFile_29_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h1E) regFile_30_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h1F) regFile_31_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h20) regFile_32_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h21) regFile_33_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h22) regFile_34_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h23) regFile_35_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h24) regFile_36_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h25) regFile_37_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h26) regFile_38_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h27) regFile_39_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h28) regFile_40_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h29) regFile_41_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h2A) regFile_42_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h2B) regFile_43_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h2C) regFile_44_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h2D) regFile_45_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h2E) regFile_46_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h2F) regFile_47_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h30) regFile_48_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h31) regFile_49_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h32) regFile_50_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h33) regFile_51_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h34) regFile_52_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h35) regFile_53_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h36) regFile_54_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h37) regFile_55_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h38) regFile_56_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h39) regFile_57_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h3A) regFile_58_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h3B) regFile_59_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h3C) regFile_60_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h3D) regFile_61_value <= io_wdata_value;
      if (io_we & io_waddr == 6'h3E) regFile_62_value <= io_wdata_value;
      if (io_we & (&io_waddr)) regFile_63_value <= io_wdata_value;
    end
  end  // always @(posedge)
...
module ADC122S625Core (
  ...
  always @(posedge io_sclk) begin
    if (reset) begin
      ...
      if (io_cs_n) csCounter <= 5'h0;
      else csCounter <= csCounter + 5'h1;
      onSamplingA <= (|(csCounter[4:2])) & ~(csCounter[4]);
      onSamplingB <= csCounter > 5'h13;
      if (~io_cs_n & onSamplingA) shiftRegA <= {io_sdo, shiftRegA[11:1]};
      if (onSamplingA) bitCounterA <= bitCounterA + 4'h1;
      else bitCounterA <= 4'h0;
      if (~io_cs_n & onSamplingB) shiftRegB <= {io_sdo, shiftRegB[11:1]};
      if (onSamplingB) bitCounterB <= bitCounterB + 4'h1;
      else bitCounterB <= 4'h0;
    end
  end  // always @(posedge)
  AsyncFIFOCore fifoA (
      .clock         (clock),
  ...
  always @(posedge io_sclk) begin
    if (reset) begin
      ...
      if (io_en) begin
        ...
        state <= _GEN_2[state];
        if (_GEN) begin
          if (io_en) bitCounter <= 5'h0;
        end else if (_GEN_1) bitCounter <= bitCounter + 5'h1;
      end else begin
        state <= 2'h0;
        bitCounter <= 5'h0;
      end
      if (_GEN & io_en) transmitReg <= {1'h0, io_buf, io_gain_n, io_shdn_n, io_dataIn_value};
      cs_n_reg <= ~io_en | (_GEN ? ~io_en & cs_n_reg : _GEN_0 & bitCounter[4] | cs_n_reg);
      sdi_reg <= io_en & (_GEN | ~_GEN_1 ? sdi_reg : _sdi_reg_T_3[0]);
      ldac_n_reg <= ~io_en | (_GEN ? io_en | ldac_n_reg : (_GEN_0 | state != 2'h2) & ldac_n_reg);
    end
  end  // always @(posedge)
