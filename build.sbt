...
lazy val datatype = (project in file("src/datatype"))
  .dependsOn(utils)
  .settings(
    name := "datatype",
    Compile / unmanagedSourceDirectories += baseDirectory.value,
...
lazy val mod = (project in file("src/mod"))
  .dependsOn(utils, datatype, dds, dsp, func)
  .settings(
    name := "mod",
    Compile / unmanagedSourceDirectories += baseDirectory.value,
    addCompilerPlugin("org.chipsalliance" % "chisel-plugin" % chiselVersion cross CrossVersion.full),
...
lazy val display = (project in file("src/display"))
  .dependsOn(utils, datatype)
  .settings(
    name := "display",
    Compile / unmanagedSourceDirectories += baseDirectory.value,
...
lazy val app = (project in file("app"))
  .dependsOn(utils, datatype, dds, dsp, mem, com, mod, func)
  .settings(
    name := "app",
    Compile / unmanagedSourceDirectories += baseDirectory.value,
    addCompilerPlugin("org.chipsalliance" % "chisel-plugin" % chiselVersion cross CrossVersion.full),
...
lazy val test = (project in file("test"))
  .dependsOn(utils, datatype, dds, dsp, mem, com, mod, func, app)
  .settings(
    name := "test",
    Compile / unmanagedSourceDirectories += baseDirectory.value,
    addCompilerPlugin("org.chipsalliance" % "chisel-plugin" % chiselVersion cross CrossVersion.full),
